...
def evalCalculation():
    ...
    try :
        ...
        clearFields()
        textResult.insert(1.0, "Wrong calculation - Error")
...
button_multiplication = tk.Button(root, text="*", command=lambda : addCalculation("*"), width = 5 , font = ("Arial", 14))
button_multiplication.grid(row=5, column=4) 

button_clear = tk.Button(root, text="C", command=clearFields, width = 11 , font = ("Arial", 14))
button_clear.grid(row=6, column=1, columnspan=2) 

button_eql = tk.Button(root, text="=", command=evalCalculation, width = 11 , font = ("Arial", 14))
button_eql.grid(row=6, column=3, columnspan=2) 
